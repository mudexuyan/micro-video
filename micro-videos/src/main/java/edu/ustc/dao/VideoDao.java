...
public interface VideoDao {
    ...
    List<Video> findAllByKeywords(int offset, int limit, String id, String title, String categoryId, String username);

    Long findTotalCountsByKeywords(String id, String title, String categoryId, String username);
}
